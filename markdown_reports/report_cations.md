...
![](images/cations/chargebalance_ggplot-1.png)<!-- -->
...
![](images/cations/camgns2-1.png)<!-- -->

![](images/cations/camgns4-1.png)<!-- -->

![](images/cations/anc-1.png)<!-- -->
...
Date: 2020-10-24
    ...
    #>  [1] harrypotter_2.1.1 drake_7.12.4      agricolae_1.3-3   car_3.0-9        
    #>  [5] carData_3.0-4     nlme_3.1-148      stringi_1.4.6     ggExtra_0.9      
    #>  [9] ggalt_0.4.0       reshape2_1.4.4    knitr_1.29        qwraps2_0.4.2    
    #> [13] cowplot_1.0.0     data.table_1.13.0 Rmisc_1.5         plyr_1.8.6       
    #> [17] lattice_0.20-41   luzlogr_0.2.0     lubridate_1.7.9   readxl_1.3.1     
    #> [21] forcats_0.5.0     stringr_1.4.0     dplyr_1.0.1       purrr_0.3.4      
    #> [25] readr_1.3.1       tidyr_1.1.1       tibble_3.0.3      ggplot2_3.3.2    
    #> [29] tidyverse_1.3.0  
    #> 
    #> loaded via a namespace (and not attached):
    #>  [1] ggnewscale_0.4.2   colorspace_1.4-1   ellipsis_0.3.1     rio_0.5.16        
    ...
    #> [33] vctrs_0.3.2        extrafontdb_1.0    xfun_0.16          openxlsx_4.1.5    
    #> [37] rvest_0.3.6        mime_0.9           miniUI_0.1.1.1     lifecycle_0.2.0   
    ...
    #> [73] foreign_0.8-80     withr_2.2.0        abind_1.4-5        ash_1.0-15        
    #> [77] modelr_0.1.8       crayon_1.3.4       questionr_0.7.1    KernSmooth_2.23-17
    #> [81] rmarkdown_2.3      progress_1.2.2     grid_4.0.2         blob_1.2.1        
